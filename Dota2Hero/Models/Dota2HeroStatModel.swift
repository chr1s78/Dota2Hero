...
//
//   let dota2HeroStat = try? newJSONDecoder().decode(Dota2HeroStat.self, from: jsonData)

import Foundation

// MARK: - Dota2HeroStatElement
struct Dota2HeroStatElement: Codable, Identifiable {
    let id: Int
...
typealias Dota2HeroStat = [Dota2HeroStatElement]
